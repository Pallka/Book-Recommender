            ...
            <div class="form card">
                <form method="post" name="login">
                    <div class="form-control">
                        <input type="text" name="username" placeholder="Username" autofocus="true"class="bodytext" required>
                    </div>
                    <div class="form-control">
                        <input type="password" name="password" placeholder="Password" class="bodytext" required>
                    </div>
                    <input type="submit" value="Log in" name="submit" class="btntwo">
                    <h2>Don`t have an account yet? <a href="registration.php"><i><b>Register</b></i></a>
                    </h2>
                </form>
            </div>
        </div>
